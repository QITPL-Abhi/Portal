...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navigateToViewProfileId = findViewById<Button>(R.id.navigateToViewProfileId)

        navigateToViewProfileId.setOnClickListener (){
            val navigateToViewProfile = Intent(this@DashboardActivity, ViewProfileActivity::class.java)
            startActivity(navigateToViewProfile)
        }
